...
{
    return "\n" +
           FormatParagraph(strprintf(_("For more information on adequately protecting your privacy and zero-knowledge cryptography, please see <%s>."),
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2015-%i Commercium Blockchain Technologies"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
